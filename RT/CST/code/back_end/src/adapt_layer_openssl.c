                 ...
                 size_t *sig_buf_bytes)
{
    ...
    uint8_t sig_transfer[1024];  /**< Signature transfer buffer on stack */
    ...
    do
    {
        ...
        err_value = cms_to_buf(cms, bio_in, sig_transfer, sig_buf_bytes, flags);
		memcpy(sig_buf,sig_transfer,*sig_buf_bytes);
    } while(0);
